 ...
 */
class ModulesProject extends ProjectBuilder
{
    ...
    {
        $modelBuilder = new \Phady\Builder\Controller(array(
            'name' => 'index',
     ...
     * @param $templatePath
     */
    private function createAllAppFiles($name, $path, $templatePath)
    {
        $getFile = $templatePath . '/project/modules/index.php';
        $putFile = $path . 'public/index.php';
        $this->generateFile($getFile, $putFile, $name);
    ...
    public function build($name, $path, $templatePath, $options)
    {
		...
		$this->copyFiles($path."app/", $templatePath."/project/modules/app/");
