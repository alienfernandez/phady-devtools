...
class Project extends Component
{
    ...
    private $_types = array(
        'module' => '\Phady\Builder\Project\ModulesProject',
    );
     ...
     *
     * @return mixed
     * @throws \Phady\Builder\BuilderException
     */
    public function build()
    {
        ...
        if (file_exists($path.'.phady')) {
            throw new BuilderException("Projects cannot be created inside Phady projects");
        }
